...
Silakan klik tombol <b>JOIN CHANNEL</b> di bawah, lalu pilih <b>VERIFIKASI</b>.</blockquote>
        ...
        btn_join = types.InlineKeyboardButton("📢 ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/{CHANNEL_USERNAME.replace('@','')}")
...
def verify(call):
    ...
    try:
        # Menghilangkan @ jika dimasukkan via username string
        target_channel = CHANNEL_USERNAME if not CHANNEL_USERNAME.startswith('@') else CHANNEL_USERNAME
